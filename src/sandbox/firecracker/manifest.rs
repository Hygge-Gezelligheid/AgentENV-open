...
pub const LINUX_IDLE_PAGE_TRACKER: &str = "linux-idle-page";
...
impl GuestMemoryWorkingSet {
    pub fn new(ranges: Vec<GuestMemoryRange>) -> Self {
        Self::new_with_tracker(MINCORE_RESIDENCY_TRACKER, ranges)
    }

    pub fn new_with_tracker(tracker: impl Into<String>, ranges: Vec<GuestMemoryRange>) -> Self {
        Self {
    ...
    pub fn validate_shape(&self) -> Result<()> {
            ...
            self.tracker == MINCORE_RESIDENCY_TRACKER || self.tracker == LINUX_IDLE_PAGE_TRACKER,
